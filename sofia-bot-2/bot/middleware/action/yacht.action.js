...
module.exports = bot.action('/yacht_menu', (ctx) => {
   try {
      ...
      return ctx.replyWithHTML(
         `<i>«Бархатный шелест белого паруса, освежающий речной бриз, яхта раскачивается на волнах, увлекая за собой в речной вояж. В Ваших руках бокал вкусного напитка, а рядом - дорогой и любящий, родной человек».</i>\n\n`,
         yachtMenuOptions
      )
   } catch (e) {
      console.log(e)
